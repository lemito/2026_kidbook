...
Игры помогают тренировать [внимание](../../../how_to_memorize/articles/vnimanie.md) и [скорость реакции](../../../1.1_structure_of_the_world/matter/articles/12_chemical_properties.md). Например, когда ты быстро решаешь головоломки или стреляешь по врагам, мозг учится быстрее обрабатывать информацию.
...
- **«Civilization VI»** — стратегическая игра, развивающая [мышление](board_and_intellectual_games.md) и [планирование](time_for_hobby_daily_routine.md).
...
Компьютерные игры могут приносить огромную пользу, если подходить к ним осознанно. Они развивают ум, тело и расширяют [кругозор](reading_and_self_education.md). Главное — правильно выбирать игры и соблюдать [баланс](balance_study_rest_hobby.md) между виртуальным миром и реальной жизнью.
