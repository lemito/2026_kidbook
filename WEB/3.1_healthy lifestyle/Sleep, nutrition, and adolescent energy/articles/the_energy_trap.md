...
>
>**2. Про [безопасность](../../../7.2_leisure/useful_and_interesting_leisure/articles/safety_during_recreation.md)**  
...
Но кофеин действует как **блокировщик этих сигналов**. Он занимает те же рецепторы, что и аденозин, и мозг перестаёт чувствовать [усталость](../../../how_to_memorize/articles/ustalost.md).
...
Проблема в том, что **усталость никуда не исчезает**. Организм всё ещё истощён, но мозг временно перестаёт это [замечать](../../../how_to_memorize/articles/vnimanie.md).
...
- артериальное [[давление](../../../1.1_structure_of_the_world/matter/articles/11_physical_properties.md)](../../../1.1_structure_of_the_world/matter/articles/07_gases.md)  
...
* **Делай перерывы.** Мозгу нужен [[отдых](../../../7.2_leisure/useful_and_interesting_leisure/articles/balance_study_rest_hobby.md)](../../../7.2_leisure/useful_and_interesting_leisure/articles/leisure_and_why_need.md) каждые 40–60 минут.
* **[Двигайся.]("./articles/sport_and_energy.md")** Короткая прогулка или лёгкая [физическая активность](../../../7.2_leisure/useful_and_interesting_leisure/articles/active_recreation_and_sport.md) может бодрить лучше кофеина.
