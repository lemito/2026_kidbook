...
> 🟢 *Реальность:* Без сна [информация](../../../5.1_technology_and_digital_literacy/information and media literacy/как_устроена_современная_информационная_среда.md) остается в «оперативной [памяти](../../../how_to_memorize/articles/pamyat.md)» и стирается к утру. Чтобы [запомнить](../../../how_to_memorize/articles/zapominanie.md), нужно поспать.
>
> **2. Про [обучение](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/sleep_and_memory_grades.md) во сне**  
> 🔴 *Миф:* «Можно слушать лекции во сне и выучить английский».  
> 🟢 *Реальность:* [Мозг](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/breakfast_for_the_brain.md) не учит новое во сне, он сортирует то, что ты узнал *днем*.
>
...
Если ты встаешь по будильнику слишком рано, ты «обрезаешь» именно эту фазу. В итоге ты помнишь [правила](../../../2.1_society/cause_and_effect_relationships/articles/why_rules_work.md), но не понимаешь, как их применять.

### Чек-лист: Как хакнуть учебу через сон

*   **«[Правило](../../../1.2_natural_sciences/why_science_help_understand_world/patterns.md) бутерброда»:** Поучил сложное → Поспал → [Повторил](../../../how_to_memorize/articles/povtorenie.md) утром. Самый эффективный способ запоминания.
*   **Никаких [энергетиков]("./articles/the_energy_trap.md") после 16:00.** [Кофеин](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/the_energy_trap.md) блокирует аденозин, но не дает мозгу войти в глубокую фазу сна. Ты спишь, но «сохранение» не работает.
*   **Сон [перед экзаменом]("./articles/stress_and_food.md") важнее зубрежки.** Лучше выучить 80% билетов и [выспаться](../../../how_to_memorize/articles/son.md), чем прочитать 100% и прийти с «отключенным» мозгом.
...
*Нейронные сети, использованные при создании статьи: OpenAI GPT-4o ([изображение](../../../5.1_technology_and_digital_literacy/information and media literacy/оценка_качества_изображений_и_видео.md)), Google Gemini 2.5 Pro*
