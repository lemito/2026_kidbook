...
- **Кража личности:** Взлом аккаунта (если у тебя слабый пароль) и рассылка гадостей от твоего имени.
...
4. **Защити аккаунты:** Настрой свою приватность так, чтобы тебе могли писать только друзья, и включи двухфакторную аутентификацию.

## Заключение

Кибербуллинг — это серьезное нарушение твоих границ и безопасности. Никто не имеет права оскорблять тебя в интернете. Помни, что твой цифровой след остается навсегда, поэтому старайся сам быть вежливым в сети и не поддерживай тех, кто травит других. Интернет должен быть безопасным местом для всех!