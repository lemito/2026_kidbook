...
В **социологии** и **психологии** конфликт определяют как процесс, в котором одна сторона осознаёт, что её [интересы](../../../7.2_leisure/useful_and_interesting_leisure/articles/how_to_understand_your_interests.md) противоположны интересам другой. Конфликт может быть явным (открытое столкновение) или скрытым (латентным). Важно понимать, что конфликт — это не всегда зло; иногда он помогает выявить проблемы и найти новые решения.
...
- Инструментальная — используется для достижения [цели](../../../7.2_leisure/useful_and_interesting_leisure/articles/how_not_to_quit_hobby.md) (например, шантаж).
