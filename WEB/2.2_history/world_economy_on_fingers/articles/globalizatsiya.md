...
Глобализация важна потому, что она помогает странам **специализироваться**. Одна страна может лучше делать электронику, другая — автомобили, третья — перевозки, четвёртая — программное обеспечение, пятая — добывать [нефть](neft_v_mirovoy_ekonomike.md) или газ.
