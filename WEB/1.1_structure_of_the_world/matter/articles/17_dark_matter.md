...
[Данные](../../../5.1_technology_and_digital_literacy/information and media literacy/приватность_и_цифровой_след.md) спутников **WMAP** и **Planck** о флуктуациях реликтового излучения позволяют точно определить соотношение различных компонентов Вселенной, подтверждая наличие [тёмной материи](01_matter.md).
...
| Эксперимент | [Местоположение](../../../5.1_technology_and_digital_literacy/information and media literacy/геолокация_и_проверка_контекста.md) | Метод |
|------------|---------------|-------|
