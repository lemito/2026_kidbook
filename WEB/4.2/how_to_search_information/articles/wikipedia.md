...
Самая ценная часть статьи — это раздел **«Источники»** (или «Ссылки», «Примечания», «Литература»).
...
Это называется **медиаграмотность** — умение работать с информацией, а не просто потреблять её.
