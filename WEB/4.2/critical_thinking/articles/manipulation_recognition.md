...
- **языковые приёмы** — двусмысленные формулировки, избыточно оценочные слова
...
Это создаёт **эффект деперсонализации**: человеку становится проще испытывать агрессию к абстрактной группе, чем к реальным людям.
...
- Ссылки на анонимные источники («источники в правительстве», «знакомый врач»)
...
5. **Разделяйте факты и оценки** — задавайте вопрос: «Это описание событий или их интерпретация?»
