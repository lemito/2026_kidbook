...
## Что такое [манипуляция](fact_and_opinion_differences.md) в медиа

**Манипуляция** — это скрытое воздействие на мнение или [поведение](../../../7.2_leisure/useful_and_interesting_leisure/articles/safety_during_recreation.md) человека, при котором автор преследует свои [цели](../../../7.2_leisure/useful_and_interesting_leisure/articles/how_not_to_quit_hobby.md), не раскрывая их читателю или зрителю.

В отличие от честной аргументации, манипуляция не апеллирует к разуму. Вместо этого она использует:

- **[эмоции](influence_of_emotions.md)** — страх, гнев, зависть, патриотизм
...
### На что обращать [внимание](../../../how_to_memorize/articles/vnimanie.md)
...
## [Пропаганда](propaganda_techniques.md) в заголовках
