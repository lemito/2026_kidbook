...
* **Mutually Exclusive** (Взаимно исключающими): Элементы не должны пересекаться. Один [факт](fact_and_opinion_differences.md) — одна категория.
...
2. **What (Что)**: Что конкретно происходит? (Сбои, задержки, [ошибки](../../../7.2_leisure/useful_and_interesting_leisure/articles/mistakes_in_choosing_hobby.md)).
...
> [!Важно]
> **Золотое правило анализа**: Если решение проблемы требует только «стараться лучше» или «нанять больше людей» — скорее всего, вы работаете с симптомом. Системное решение меняет *[правила](../../../7.2_leisure/useful_and_interesting_leisure/articles/safety_during_recreation.md) игры*, а не интенсивность усилий.
