...
**Статистическая [[манипуляция](manipulation_recognition.md)](fact_and_opinion_differences.md)** — это способ представить данные так, чтобы они поддерживали нужную точку зрения.
