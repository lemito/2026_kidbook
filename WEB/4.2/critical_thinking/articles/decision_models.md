...
Принятие решения — это не одномоментный акт воли, а технологический процесс. Когда проблема структурирована, необходимо выбрать оптимальный путь её устранения. Использование формальных моделей позволяет минимизировать [влияние](../../../7.2_leisure/useful_and_interesting_leisure/articles/leisure_influence_on_future.md) [«человеческого фактора»](main_cognitive_distortions.md) — страха, предвзятости и ограниченности воображения.
...
Интеллект-карты, популяризированные Тони Бьюзеном, позволяют преодолеть линейность текста. Это инструмент **радиантного мышления**, который задействует оба полушария мозга: левое ([[логика](../../../7.2_leisure/useful_and_interesting_leisure/articles/board_and_intellectual_games.md)](methods_of_logical_inference.md), слова) и правое (образы, цвет, пространство).
...
2. **Первичные ветви (BOIs — Basic Ordering Ideas)**: Основные векторы движения. Например: «Техническое решение», «Организационные изменения», «Бюджет», «[Риски](../../../7.2_leisure/useful_and_interesting_leisure/articles/safety_during_recreation.md)».
...
Метод Эдварда де Боно решает главную проблему совещаний — «[спор](logical_errors_and_sophisms.md) ради спора». Вместо того чтобы один человек доказывал пользу, а другой — вред, вся команда одновременно надевает одну шляпу.

### Подробный регламент сессии:

* **Синяя (5 мин)**: Установка [цели](../../../7.2_leisure/useful_and_interesting_leisure/articles/how_not_to_quit_hobby.md). «Сегодня мы решаем, переходить ли на новую архитектуру».
