# [[Медиаграмотность](../../4.2/critical_thinking/articles/information_bubbles.md)](../../4.2/critical_thinking/articles/manipulation_recognition.md)
...
Сегодня мы живём в мире информации и медиа. Каждый день нас окружают разные источники информации: [книги](../../7.2_leisure/useful_and_interesting_leisure/articles/reading_and_self_education.md), газеты, телевидение, интернет, игры и [музыка](music.md). Чтобы разобраться во всём этом многообразии и не потеряться среди фейков и заблуждений, нам нужна особая способность – медиаграмотность. 
...
### [[Критическое [мышление](../../7.2_leisure/useful_and_interesting_leisure/articles/board_and_intellectual_games.md)](../../4.2/critical_thinking/articles/source_evaluation.md)](../../4.2/critical_thinking/articles/methods_of_logical_inference.md)
...
Этические нормы помогают нам уважительно относиться к другим людям и их мнению. Например, не выкладывать фотографии других без разрешения и не использовать чужие [идеи](../../7.2_leisure/useful_and_interesting_leisure/articles/free_leisure_activities.md) без указания автора.
...
- **Телевизор:** Перед просмотром новостей подумай, откуда берутся эти новости? Какие [цели](../../7.2_leisure/useful_and_interesting_leisure/articles/how_not_to_quit_hobby.md) преследуют журналисты? Какую точку зрения они представляют?
...
- **Дезинформация:** [Фейковые новости](../../4.2/critical_thinking/articles/information_verification.md) и ложные утверждения могут повлиять на твоё [мнение](../../4.2/critical_thinking/articles/fact_and_opinion_differences.md) и [поведение](../../7.2_leisure/useful_and_interesting_leisure/articles/safety_during_recreation.md).
