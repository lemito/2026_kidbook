...
### **Симулятор**
Эти игры позволяют игрокам управлять реальными или вымышленными объектами и наблюдать их [[[развитие](../../7.2_leisure/useful_and_interesting_leisure/articles/leisure_influence_on_future.md)](../../7.2_leisure/useful_and_interesting_leisure/articles/reading_and_self_education.md)](../../7.2_leisure/useful_and_interesting_leisure/articles/useful_vs_useless_leisure.md). Например, SimCity позволяет строить города и следить за тем, как они растут и развиваются.
...
- Позволяют тренировать [память](../../7.2_leisure/useful_and_interesting_leisure/articles/board_and_intellectual_games.md) и улучшать математические способности.
...
- Старайся совмещать игры с другими видами деятельности, такими как [спорт](../../7.2_leisure/useful_and_interesting_leisure/articles/active_recreation_and_sport.md) или чтение книг.
