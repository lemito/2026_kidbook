...
* **WEB** - раздел для финальных HTML-страничек [книги](WEB/7.2_leisure/useful_and_interesting_leisure/articles/reading_and_self_education.md). Это тот код, который затем будет оформляться как окончательная энциклопедия на GitHub Pages.
