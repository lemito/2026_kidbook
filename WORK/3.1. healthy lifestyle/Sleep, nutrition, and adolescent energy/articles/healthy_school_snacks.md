# Здоровый перекус в школе: [идеи](../../../../WEB/7.2_leisure/useful_and_interesting_leisure/articles/free_leisure_activities.md) ланч-боксов, которые не стыдно взять с собой
...
> 🟢 *Реальность:* Если перекус состоит только из сахара, [энергия](../../../../WEB/1.1_structure_of_the_world/matter/articles/01_matter.md) быстро взлетит и так же быстро рухнет.
>
...
— [Баланс](../../../../WEB/7.2_leisure/useful_and_interesting_leisure/articles/balance_study_rest_hobby.md) держится внутри меня.
