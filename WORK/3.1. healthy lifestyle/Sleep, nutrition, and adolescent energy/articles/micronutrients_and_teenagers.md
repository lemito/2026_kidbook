...
Особенно важны для подростков **железо, магний и витамины группы B**. Их нехватка может вызывать [усталость](../../../../WEB/how_to_memorize/articles/ustalost.md), проблемы с концентрацией и даже перепады настроения.
...
- **B9 (фолиевая [кислота](../../../../WEB/1.1_structure_of_the_world/matter/articles/12_chemical_properties.md))** — важен для роста клеток  
...
- проблемы с [памятью](../../../../WEB/how_to_memorize/articles/pamyat.md)  
